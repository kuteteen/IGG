...
static NSString *const PSW_AES_KEY = @"IjqaYYhuTgzoePOl";
...
- (NSData *)AES128operation:(CCOperation)operation data:(NSData *)data key:(NSString *)key iv:(NSString *)iv {
    ...
    CCCryptorStatus cryptorStatus = CCCrypt(operation, kCCAlgorithmAES128, 0x0000 | kCCOptionECBMode|kCCOptionPKCS7Padding,
